...
class InviteReason extends react.PureComponent {
  constructor(props) {
    super(props);
...
class RoomPreviewBar extends react.Component {
  constructor(props) {
    super(props);
...
(0,defineProperty/* default */.Z)(RoomPreviewBar, "defaultProps", {
  onJoinClick() {}
});
...
class RoomUpgradeWarningBar extends react.PureComponent {
  constructor(...args) {
    super(...args);
...
class AppsDrawer extends react.Component {
  constructor(props) {
    super(props);
...
(0,defineProperty/* default */.Z)(AppsDrawer, "propTypes", {
...
(0,defineProperty/* default */.Z)(AppsDrawer, "defaultProps", {
  showApps: true
});
...
class CallViewForRoom extends react.Component {
  constructor(props) {
    super(props);
    (0,defineProperty/* default */.Z)(this, "dispatcherRef", void 0);
    (0,defineProperty/* default */.Z)(this, "onAction", payload => {
...
// @replaceableComponent("views.rooms.P2PInvite")
class P2PInvite extends react.Component {
  constructor(...args) {
    super(...args);
...
(0,defineProperty/* default */.Z)(AuxPanel, "defaultProps", {
  showApps: true,
  P2PModalType: 0,
  P2PModalInfo: null
});
...
class RoomHeaderButtons extends HeaderButtons/* default */.Z {
  constructor(props) {
...
class RoomHeader extends react.PureComponent {
...
(0,defineProperty/* default */.Z)(RoomHeader, "defaultProps", {
  editing: false,
  inRoom: false
});
(0,defineProperty/* default */.Z)(RoomHeader, "contextType", RoomContext/* default */.Z);
...
class SearchResultTile extends react.Component {
  render() {
...
(0,defineProperty/* default */.Z)(SearchResultTile, "contextType", RoomContext/* default */.Z);
...
class TopUnreadMessagesBar extends react.PureComponent {
  render() {
    return /*#__PURE__*/react.createElement("div", {
...
(0,defineProperty/* default */.Z)(RoomView, "contextType", MatrixClientContext/* default */.Z);
