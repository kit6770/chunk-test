...
/* harmony import */ var _hiseas_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(989638);
...
/* harmony import */ var _SdkConfig__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(374312);
...
const NFT_PROFILE_HOST_URL = _SdkConfig__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z.get()['dapp']['fav_host_url'];
// @replaceableComponent("views.messages.CardBody")
class CardBody extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(...args) {
    super(...args);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this, "msgParser", msg => {
      ...
      if (content.body) {
        try {
          ...
          switch (handler) {
            case _hiseas_react__WEBPACK_IMPORTED_MODULE_2__.MsgHandler.token:
              return Promise.resolve(_objectSpread(_objectSpread({}, body), {}, {
                props: _objectSpread(_objectSpread({}, body.props), {}, {
                  updateTime: '1D',
                  updateTitle: '24H',
                  onClick: () => {
                    body.props.slug && _dispatcher_dispatcher__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP.dispatch({
                      ...
                      refireParams: {
                        params: {
                          ...
                          title: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_6__._t)('Crypto Profile')
                        }
                      }
                    });
                  }
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_hiseas_react__WEBPACK_IMPORTED_MODULE_2__.MsgCard, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)({
