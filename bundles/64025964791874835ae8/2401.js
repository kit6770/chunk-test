...
/* harmony import */ var _ContentMessages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(601877);
/* harmony import */ var _elements_ImageView__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(95727);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(294184);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(681811);
/* harmony import */ var _MessageTimestamp__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(982820);
/* harmony import */ var _MGifStar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(615381);
...
class MGifBody extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props) {
    super(props);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "unmounted", true);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "image", /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createRef)());
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "timeout", void 0);
    // FIXME: factor this out and apply it to MVideoBody and MAudioBody too!
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onClientSync", (syncState, prevState) => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onClick", ev => {
      if (ev.button === 0 && !ev.metaKey) {
        ...
        _Modal__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.createDialog(_elements_ImageView__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, params, "mx_Dialog_lightbox mx_ImageView_Dialog", null, false);
      }
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "isGif", () => {
      var _content$info;
      const content = this.props.mxEvent.getContent();
      return ((_content$info = content.info) === null || _content$info === void 0 ? void 0 : _content$info.mimetype) === "image/gif";
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onImageEnter", e => {
      this.setState({
        hover: true
      });
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onImageLeave", e => {
      this.setState({
        hover: false
      });
      if (!this.state.showImage || !this.isGif() || _settings_SettingsStore__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .C.getValue("autoplayGifs")) {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onImageError", () => {
      this.clearBlurhashTimeout();
      this.setState({
        imgError: true
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "onImageLoad", () => {
      this.clearBlurhashTimeout();
  ...
  get media() {
    return (0,_customisations_Media__WEBPACK_IMPORTED_MODULE_7__/* .mediaFromContent */ .z3)(this.props.mxEvent.getContent());
  }
  getThumbUrl() {
    ...
    const content = this.props.mxEvent.getContent();
    const media = (0,_customisations_Media__WEBPACK_IMPORTED_MODULE_7__/* .mediaFromContent */ .z3)(content);
  ...
  componentDidMount() {
    ...
    if ((_this$props$mxEvent$g = this.props.mxEvent.getContent().info) !== null && _this$props$mxEvent$g !== void 0 && _this$props$mxEvent$g[_ContentMessages__WEBPACK_IMPORTED_MODULE_8__/* .BLURHASH_FIELD */ .kP]) {
      this.clearBlurhashTimeout();
  ...
  messageContent(contentUrl, thumbUrl, content, forcedHeight) {
    ...
    const classes = classnames__WEBPACK_IMPORTED_MODULE_10___default()({
      'mx_MImageBody_thumbnail': true,
      'mx_MImageBody_thumbnail--blurhash': (_this$props$mxEvent$g2 = this.props.mxEvent.getContent().info) === null || _this$props$mxEvent$g2 === void 0 ? void 0 : _this$props$mxEvent$g2[_ContentMessages__WEBPACK_IMPORTED_MODULE_8__/* .BLURHASH_FIELD */ .kP]
    });

    // This has incredibly broken types.
    const C = react_transition_group__WEBPACK_IMPORTED_MODULE_14__/* .CSSTransition */ .Kv;
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_14__/* .SwitchTransition */ .TL, {
      mode: "out-in"
  ...
  getPlaceholder(width, height) {
    ...
    const blurhash = (_this$props$mxEvent$g3 = this.props.mxEvent.getContent().info) === null || _this$props$mxEvent$g3 === void 0 ? void 0 : _this$props$mxEvent$g3[_ContentMessages__WEBPACK_IMPORTED_MODULE_8__/* .BLURHASH_FIELD */ .kP];
    if (blurhash) {
  ...
  getFileBody(content) {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MGifStar__WEBPACK_IMPORTED_MODULE_12__["default"], {
      content: content
  ...
  render() {
    const content = this.props.mxEvent.getContent();
    const timestamp = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageTimestamp__WEBPACK_IMPORTED_MODULE_11__["default"], {
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(MGifBody, "contextType", _contexts_MatrixClientContext__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z);
