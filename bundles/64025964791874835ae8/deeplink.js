...
;// CONCATENATED MODULE: ./src/vector/deeplink/android.ts

class Android {
  constructor(props) {
    _defineProperty(this, "fallbackWebUrl", void 0);
    _defineProperty(this, "storeUrl", void 0);
    ...
    this.storeUrl = 'market://details?id=';
    this.fallbackWebUrl = props === null || props === void 0 ? void 0 : props.fallbackWebUrl;
    this.appId = props === null || props === void 0 ? void 0 : props.appId;
    this._browser = 'default browser';
  }
  get browser() {
  ...
  getStoreURL() {
    ...
    const id = this.appId;
    return id && appName ? baseurl + appName + "/id" + id + "?mt=8" : null;
  }
  openDapp(url) {
...
;// CONCATENATED MODULE: ./src/vector/deeplink/ios.ts
...
;// CONCATENATED MODULE: ./src/vector/deeplink/web.ts
...
class WebDeepLink {
  constructor(props) {
    ...
    _defineProperty(this, "fallbackWebUrl", void 0);
    _defineProperty(this, "storeUrl", void 0);
    _defineProperty(this, "openDapp", uri => {
      const url = new URL(uri);
      const params = uri.substring(uri.indexOf(url.hostname) + url.hostname.length + url.pathname.length);
...
;// CONCATENATED MODULE: ./src/vector/deeplink/deeplink.ts
...
class DeepLinkApp {
  constructor(props = {}) {
    ...
    _defineProperty(this, "_fallbackWebUrl", void 0);
    _defineProperty(this, "setup", ({
      ios,
      android,
      setting
    }) => {
      if (DeepLinkApp.isIos) {
        this.platform = new MacOS(ios);
      } else if (DeepLinkApp.isAndroid) {
        this.platform = new Android(android);
      } else {
        this.platform = new WebDeepLink();
      }
      this.settings = setting;
    });
    _defineProperty(this, "getWebLink", () => {
      return this._fallbackWebUrl || location.href;
    });
    _defineProperty(this, "getStoreLink", () => {
      return this.platform.getStoreURL();
    });
    _defineProperty(this, "openFallback", ts => {
      return () => {
    ...
    this._fallbackWebUrl = `${location.origin}/mobile_guide`;
    if (DeepLinkApp.isIos) {
...
_class = DeepLinkApp;
_defineProperty(DeepLinkApp, "internalInstance", void 0);
...
;// CONCATENATED MODULE: ./src/vector/deeplink/index.tsx
...
const allParams = (() => {
  ...
  const param = {};
  if (url.indexOf("?") != -1) {
    url.split("?")[1].split(/[&#]/).forEach(function (paramStr) {
...
const App = () => {
  (0,react.useEffect)(() => {
    const init = () => {
      // DeepLinkApp.instance.open('https://metamask.app.link/dapp/www.baidu.com');
      let url;
      let dapp;
      if (location.href.indexOf('?url=') > -1) {
        url = location.href.substring(location.href.indexOf('?url=') + 5);
      }
      if (location.href.indexOf('?dapp=') > -1) {
        dapp = location.href.substring(location.href.indexOf('?dapp=') + 6);
      }
      if (dapp) {
        DeepLinkApp.instance.openDapp(dapp);
        return;
      }
      if (url) {
        DeepLinkApp.instance.open(url);
      }
      console.log(dapp);
    };
    init();
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "title"
  }, /*#__PURE__*/react.createElement("div", null, "Click the upper right corner "), /*#__PURE__*/react.createElement("div", null, "Select Open in ", /*#__PURE__*/react.createElement("span", {
    className: "browser"
  }, DeepLinkApp.instance.platform.browser))), /*#__PURE__*/react.createElement("div", {
    className: "logo"
  }), /*#__PURE__*/react.createElement("div", {
    className: "line"
  }));
...
// http://localhost:8080/deeplink?qrcode=c42512d5ee5146a397c2eb118459184f
const QrcodeApp = () => {
  const qrcode = allParams.qrcode || "";
  const [invalid, setInvalid] = (0,react.useState)(false);
  (0,react.useEffect)(() => {
    const init = async () => {
      const config = await getVectorConfig("..");
      const serverName = config !== null && config !== void 0 && config.sdn_homeserver ? config === null || config === void 0 ? void 0 : config.sdn_homeserver : "";
      if (qrcode) {
        const result = await fetch(`${serverName || ""}/_api/client/r0/invitation/parseQRCode/${qrcode}`);
        const data = await result.json();
        if (data.errcode === 'M_UNKNOWN' || !data.redirect_uri) {
          setInvalid(true);
        } else {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "qrcode_content"
  }, invalid && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("img", {
    src: "/themes/element/img/backgrounds/invalid_status.png"
  }), /*#__PURE__*/react.createElement("p", null, "Invalid QR code")));
};
if (allParams.qrcode) {
  document.getElementById("deeplink").className = "qrcode_root";
  (0,react_dom.render)( /*#__PURE__*/react.createElement(QrcodeApp, null), document.getElementById("deeplink"));
} else {
  document.getElementById("deeplink").className = "deeplink";
  (0,react_dom.render)( /*#__PURE__*/react.createElement(App, null), document.getElementById("deeplink"));
}
})();
