...
/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(877294);
...
let MLocationBody = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_1__/* .replaceableComponent */ .U)("views.messages.MLocationBody"), _dec(_class = class MLocationBody extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props) {
    super(props);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(this, "IMAGE_WIDTH", 240);
    // snapshot width
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(this, "IMAGE_HEIGHT", 160);
    // snapshot height
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(this, "ZOOM_IN", 13);
    this.state = {};
  }
  get content() {
  ...
  async getImage() {
    ...
    const url = `https://maps.googleapis.com/maps/api/staticmap?center=${longitude},${latitude}` + `&zoom=${this.ZOOM_IN}` + `&size=${this.IMAGE_WIDTH}x${this.IMAGE_HEIGHT}` + `&maptype=roadmap` + `&scale=2` + `&markers=${encodeURIComponent(markers)}` + `&key=${_lib_constants__WEBPACK_IMPORTED_MODULE_2__/* .GOOCLE_MAPS_ACCESS_TOKEN */ .rk}`;
