...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(166644);
...
/* harmony import */ var blurhash__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(213060);
/* harmony import */ var blurhash__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(blurhash__WEBPACK_IMPORTED_MODULE_15__);
...
/* harmony import */ var _customisations_Media__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(834208);
/* harmony import */ var _ContentMessages__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(601877);
/* harmony import */ var _MFileBody__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(393562);
/* harmony import */ var _MessageTimestamp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(982820);
/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(241648);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(769215);
/* harmony import */ var _MatrixClientPeg__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(933393);
/* harmony import */ var _elements_ImageView__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(95727);
/* harmony import */ var _rooms_EventTile__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(585340);
/* harmony import */ var react_blurhash__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(668288);
/* harmony import */ var react_blurhash__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(react_blurhash__WEBPACK_IMPORTED_MODULE_13__);
...
let MVideoBody = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_4__/* .replaceableComponent */ .U)("views.messages.MVideoBody"), _dec(_class = class MVideoBody extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  constructor(props) {
    super(props);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(this, "videoRef", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createRef());
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(this, "init", async () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(this, "videoOnPlay", async () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(this, "handleClick", () => {
      const content = this.props.mxEvent.getContent();
      ...
      _Modal__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.createDialog(_elements_ImageView__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z, params, "mx_Dialog_lightbox mx_ImageView_Dialog", null, false);
    });
    this.state = {
      fetchingData: false,
      decryptedUrl: null,
  ...
  async checkMessageStatus() {
    ...
    const content = this.props.mxEvent.getContent();
    const matrixClient = _MatrixClientPeg__WEBPACK_IMPORTED_MODULE_10__/* .MatrixClientPeg */ .p.get();
    if (status === "sending" && content.prepContent) {
      try {
        ...
        const upload = _ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .ZP.sharedInstance().getUploadPromise(eventId);
        // upload thumbnail
        const uploadResult = await (0,_ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* .uploadParts */ .Mj)(matrixClient, this.props.mxEvent.getRoomId(), thumbnail);
        ...
        if (!upload || !(upload !== null && upload !== void 0 && upload.onProgress)) {
          ...
          _ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .ZP.sharedInstance().uploadFileMessage(this.props.mxEvent, _MatrixClientPeg__WEBPACK_IMPORTED_MODULE_10__/* .MatrixClientPeg */ .p.get(), onProgress, complete);
        } else {
        ...
        throw new _ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* .UploadCanceledError */ .I0();
      }
    }
  }
  ...
  getContentUrl() {
    ...
    const media = (0,_customisations_Media__WEBPACK_IMPORTED_MODULE_5__/* .mediaFromContent */ .z3)(this.props.mxEvent.getContent());
  ...
  getThumbUrl() {
    ...
    const media = (0,_customisations_Media__WEBPACK_IMPORTED_MODULE_5__/* .mediaFromContent */ .z3)(content);
  ...
  loadBlurhash() {
    ...
    if (!info[_ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* .BLURHASH_FIELD */ .kP]) return;
    ...
    const pixels = (0,blurhash__WEBPACK_IMPORTED_MODULE_15__.decode)(info[_ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* .BLURHASH_FIELD */ .kP], width, height);
  ...
  handleCancelUpload() {
    ...
    _ContentMessages__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .ZP.sharedInstance().cancelUpload(uploadEventId, _MatrixClientPeg__WEBPACK_IMPORTED_MODULE_10__/* .MatrixClientPeg */ .p.get());
  }
  revokeObjectUrl(objectUrl) {
    URL.revokeObjectURL(objectUrl);
  }
  renderPreview(autoplay) {
    const timestamp = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageTimestamp__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_16__.Progress, {
      type: "circle",
  ...
  render() {
    ...
    if (this.state.error !== null) {
      if (this.props.tileShape === _rooms_EventTile__WEBPACK_IMPORTED_MODULE_12__/* .TileShape */ .GO.ImageGrid) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_blurhash__WEBPACK_IMPORTED_MODULE_13__.Blurhash, {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        ...
        dir: "auto"
      }, (0,_languageHandler__WEBPACK_IMPORTED_MODULE_1__._t)("Error decrypting video")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageTimestamp__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ts: this.props.mxEvent.getTs(),
        showHourMinute: true
      }));
    }
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      ...
      onPlay: this.videoOnPlay,
      onLoadedMetadata: this.videoOnPlay
    }), this.props.tileShape && this.props.tileShape !== _rooms_EventTile__WEBPACK_IMPORTED_MODULE_12__/* .TileShape */ .GO.ImageGrid && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MFileBody__WEBPACK_IMPORTED_MODULE_7__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z)({}, this.props, {
      showGenericPlaceholder: false
    })), this.props.tileShape !== _rooms_EventTile__WEBPACK_IMPORTED_MODULE_12__/* .TileShape */ .GO.ImageGrid && timestamp);
  }
}) || _class);
