...
let ForgotPassword = (_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.auth.ForgotPassword"), _dec(_class = class ForgotPassword extends react.Component {
  constructor(props) {
    super(props);
