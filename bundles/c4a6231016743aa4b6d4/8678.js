...
/* harmony import */ var _elements_Tooltip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(578413);
...
let ReactionsRowButtonTooltip = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_4__/* .replaceableComponent */ .U)("views.messages.ReactionsRowButtonTooltip"), _dec(_class = (_class2 = class ReactionsRowButtonTooltip extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  render() {
    const {
      content,
      reactionEvents,
    ...
    let tooltip;
    if (tooltipLabel) {
      tooltip = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_elements_Tooltip__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
        visible: visible,
        label: tooltipLabel
      });
    }
...
}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(_class2, "contextType", _contexts_MatrixClientContext__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z), _class2)) || _class);
