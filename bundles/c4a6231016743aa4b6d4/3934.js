(self["webpackChunkhisease_im_web"] = self["webpackChunkhisease_im_web"] || []).push([[3934],{
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(225259);
...
/* harmony import */ var file_saver__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(293162);
...
/* harmony import */ var _SecurityManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(524443);
/* harmony import */ var _utils_strings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(653848);
/* harmony import */ var _components_views_auth_InteractiveAuthEntryComponents__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(630761);
/* harmony import */ var _components_views_auth_PassphraseField__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(229049);
/* harmony import */ var _components_views_elements_StyledRadioButton__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(861766);
/* harmony import */ var _components_views_elements_AccessibleButton__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(805035);
/* harmony import */ var _components_views_elements_DialogButtons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(804821);
/* harmony import */ var _components_views_elements_InlineSpinner__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(650193);
/* harmony import */ var _components_views_dialogs_security_RestoreKeyBackupDialog__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(854601);
/* harmony import */ var _utils_WellKnownUtils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(897724);
/* harmony import */ var _customisations_Security__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(231394);
...
class CreateSecretStorageDialog extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  constructor(props) {
    super(props);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onKeyBackupStatusChange", () => {
      if (this.state.phase === PHASE_MIGRATE) this._fetchBackupInfo();
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onKeyPassphraseChange", e => {
      this.setState({
        passPhraseKeySelected: e.target.value
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_collectRecoveryKeyNode", n => {
      this._recoveryKeyNode = n;
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onChooseKeyPassphraseFormSubmit", async () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onMigrateFormSubmit", e => {
      e.preventDefault();
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onCopyClick", () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onDownloadClick", () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_doBootstrapUIAuth", async makeRequest => {
      if (this.state.canUploadKeysWithPasswordOnly && this.state.accountPassword) {
        ...
        const InteractiveAuthDialog = _index__WEBPACK_IMPORTED_MODULE_2__.getComponent("dialogs.InteractiveAuthDialog");
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_bootstrapSecretStorage", async () => {
      this.setState({
        phase: PHASE_STORING,
        error: null
      });
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onCancel", () => {
      this.props.onFinished(false);
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onDone", () => {
      this.props.onFinished(true);
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_restoreBackup", async () => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onLoadRetryClick", () => {
      this.setState({
        phase: PHASE_LOADING
      });
      this._fetchBackupInfo();
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onShowKeyContinueClick", () => {
      this._bootstrapSecretStorage();
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onCancelClick", () => {
      this.setState({
        phase: PHASE_CONFIRM_SKIP
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onGoBackClick", () => {
      this.setState({
        phase: PHASE_CHOOSE_KEY_PASSPHRASE
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onPassPhraseNextClick", async e => {
      e.preventDefault();
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onPassPhraseConfirmNextClick", async e => {
      e.preventDefault();
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onSetAgainClick", () => {
      this.setState({
        passPhrase: '',
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onPassPhraseValidate", result => {
      this.setState({
        passPhraseValid: result.valid
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onPassPhraseChange", e => {
      this.setState({
        passPhrase: e.target.value
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onPassPhraseConfirmChange", e => {
      this.setState({
        passPhraseConfirm: e.target.value
      });
    });
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(this, "_onAccountPasswordChange", e => {
      this.setState({
  ...
  _renderPhaseMigrate() {
    ...
    const Field = _index__WEBPACK_IMPORTED_MODULE_2__.getComponent('views.elements.Field');
    let authPrompt;
  ...
  _renderBusyPhase() {
    const Spinner = _index__WEBPACK_IMPORTED_MODULE_2__.getComponent('views.elements.Spinner');
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(CreateSecretStorageDialog, "propTypes", {
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(CreateSecretStorageDialog, "defaultProps", {
  hasCancel: true,
  forceReset: false
});
