...
let PersistentApp = (_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.elements.PersistentApp"), _dec(_class = class PersistentApp extends react.Component {
  constructor(...args) {
    super(...args);
...
var PictureInPictureDragger_dec, PictureInPictureDragger_class;
/*
 ...
 */
let PictureInPictureDragger = (PictureInPictureDragger_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.voip.PictureInPictureDragger"), PictureInPictureDragger_dec(PictureInPictureDragger_class = class PictureInPictureDragger extends react.Component {
  constructor(props) {
    super(props);
 ...
 * (PiP mode). It displays the call(s) which is *not* in the room the user is currently viewing.
 */
let CallPreview = (CallPreview_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.voip.CallPreview"), CallPreview_dec(CallPreview_class = class CallPreview extends react.Component {
  constructor(props) {
    super(props);
...
var CallContainer_dec, CallContainer_class;
/*
Copyright 2020 The Matrix.org Foundation C.I.C.
Copyright 2021 Šimon Brandner <simon.bra.ag@gmail.com>
...
let CallContainer = (CallContainer_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.voip.CallContainer"), CallContainer_dec(CallContainer_class = class CallContainer extends react.PureComponent {
  render() {
    return /*#__PURE__*/react.createElement("div", {
...
var NonUrgentToastContainer_dec, NonUrgentToastContainer_class;
/*
Copyright 2020 The Matrix.org Foundation C.I.C.
...
let NonUrgentToastContainer = (NonUrgentToastContainer_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.NonUrgentToastContainer"), NonUrgentToastContainer_dec(NonUrgentToastContainer_class = class NonUrgentToastContainer extends react.PureComponent {
...
var HostSignupDialog_dec, HostSignupDialog_class;
/*
Copyright 2021 The Matrix.org Foundation C.I.C.
...
let HostSignupDialog = (HostSignupDialog_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.dialogs.HostSignupDialog"), HostSignupDialog_dec(HostSignupDialog_class = class HostSignupDialog extends react.PureComponent {
  constructor(props) {
    super(props);
...
var ToastContainer_dec, ToastContainer_class;
/*
Copyright 2019, 2020 The Matrix.org Foundation C.I.C.
...
let ToastContainer = (ToastContainer_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.ToastContainer"), ToastContainer_dec(ToastContainer_class = class ToastContainer extends react.Component {
  constructor(props, context) {
    super(props, context);
...
var MyGroups_dec, MyGroups_class, _class2;
/*
...
let MyGroups = (MyGroups_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.MyGroups"), MyGroups_dec(MyGroups_class = (_class2 = class MyGroups extends react.Component {
  constructor(...args) {
    super(...args);
    (0,defineProperty/* default */.Z)(this, "state", {
      groups: null,
...
}, (0,defineProperty/* default */.Z)(_class2, "contextType", MatrixClientContext/* default */.Z), _class2)) || MyGroups_class);
...
var UserView_dec, UserView_class;
/*
...
let UserView = (UserView_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.UserView"), UserView_dec(UserView_class = class UserView extends react.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true
...
var GroupHeaderButtons_dec, GroupHeaderButtons_class;
/*
...
let GroupHeaderButtons = (GroupHeaderButtons_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.right_panel.GroupHeaderButtons"), GroupHeaderButtons_dec(GroupHeaderButtons_class = class GroupHeaderButtons extends HeaderButtons/* default */.Z {
  constructor(props) {
...
var RoomDetailRow_dec, RoomDetailRow_class, RoomDetailRow_class2;
/*
...
let RoomDetailRow = (RoomDetailRow_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.rooms.RoomDetailRow"), RoomDetailRow_dec(RoomDetailRow_class = (RoomDetailRow_class2 = class RoomDetailRow extends react.Component {
  constructor(props) {
    super(props);
...
}, (0,defineProperty/* default */.Z)(RoomDetailRow_class2, "propTypes", {
  room: roomShape,
  // passes ev, room as args
  onClick: (prop_types_default()).func,
  onMouseDown: (prop_types_default()).func
}), RoomDetailRow_class2)) || RoomDetailRow_class);
...
var GroupView_dec, _class5, _class6;
/*
Copyright 2017 Vector Creations Ltd.
Copyright 2017, 2018 New Vector Ltd.
Copyright 2019 The Matrix.org Foundation C.I.C.
...
let GroupView = (GroupView_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.GroupView"), GroupView_dec(_class5 = (_class6 = class GroupView extends react.Component {
  constructor(...args) {
    super(...args);
    (0,defineProperty/* default */.Z)(this, "state", {
      summary: null,
...
}, (0,defineProperty/* default */.Z)(_class6, "propTypes", {
  groupId: (prop_types_default()).string.isRequired,
...
var NotificationPanel_dec, NotificationPanel_class;
/*
 ...
 */
let NotificationPanel = (NotificationPanel_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.NotificationPanel"), NotificationPanel_dec(NotificationPanel_class = class NotificationPanel extends react.PureComponent {
  constructor(props) {
    super(props);
...
var ContactPanel_dec, ContactPanel_class;
/*
Copyright 2016, 2019, 2021 The Matrix.org Foundation C.I.C.
 ...
 * Component which shows the global notification list using a TimelinePanel
 */
let ContactPanel = (ContactPanel_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.ContactPanel"), ContactPanel_dec(ContactPanel_class = class ContactPanel extends react.PureComponent {
  constructor(props) {
    super(props);
    (0,defineProperty/* default */.Z)(this, "disposers", []);
  }
...
FloatingWidgetStore_class = FloatingWidgetStore;
...
var FriendApply_dec, FriendApply_class;
...
let FriendApply = (FriendApply_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.invite.FriendApply"), FriendApply_dec(FriendApply_class = class FriendApply extends react.Component {
  constructor(props) {
    super(props);
...
var LoggedInView_dec, LoggedInView_class, LoggedInView_class2;
 ...
 */
let LoggedInView = (LoggedInView_dec = (0,replaceableComponent/* replaceableComponent */.U)("structures.LoggedInView"), LoggedInView_dec(LoggedInView_class = (LoggedInView_class2 = class LoggedInView extends react.PureComponent {
  constructor(props, context) {
...
}, (0,defineProperty/* default */.Z)(LoggedInView_class2, "displayName", "LoggedInView"), LoggedInView_class2)) || LoggedInView_class);
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(166644);
/* harmony import */ var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(992619);
...
let HeaderButton = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_3__/* .replaceableComponent */ .U)("views.right_panel.HeaderButton"), _dec(_class = class HeaderButton extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(...args) {
    super(...args);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, "onClick", e => {
  ...
  render() {
    ...
    const _this$props = this.props,
      ...
      props = (0,_babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(_this$props, _excluded);
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(sendingme_ui__WEBPACK_IMPORTED_MODULE_4__.SdTooltip, {
      title: title,
      placement: "bottom"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(sendingme_ui__WEBPACK_IMPORTED_MODULE_4__.SdButton, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)({}, props, {
      "aria-selected": isHighlighted,
      role: "tab",
      className: classes,
      onClick: this.onClick
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(sendingme_ui__WEBPACK_IMPORTED_MODULE_4__.SdIcon, {
      icon: name
    })));
  }
}) || _class);
...
let HeaderButtons = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_4__/* .replaceableComponent */ .U)("views.right_panel.HeaderButtons"), _dec(_class = class HeaderButtons extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props, kind) {
    super(props);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, "storeToken", void 0);
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, "dispatcherRef", void 0);
...
let VideoFeed = (_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.voip.VideoFeed"), _dec(_class = class VideoFeed extends react.PureComponent {
  constructor(props) {
    super(props);
...
var DesktopCapturerSourcePicker_dec, _class2;
/*
Copyright 2021 Šimon Brandner <simon.bra.ag@gmail.com>
...
let DesktopCapturerSourcePicker = (DesktopCapturerSourcePicker_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.elements.DesktopCapturerSourcePicker"), DesktopCapturerSourcePicker_dec(_class2 = class DesktopCapturerSourcePicker extends react.Component {
  constructor(props) {
    super(props);
...
var CallContextMenu_dec, CallContextMenu_class, CallContextMenu_class2;
/*
...
let CallContextMenu = (CallContextMenu_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.context_menus.CallContextMenu"), CallContextMenu_dec(CallContextMenu_class = (CallContextMenu_class2 = class CallContextMenu extends react.Component {
  constructor(props) {
    super(props);
...
}, (0,defineProperty/* default */.Z)(CallContextMenu_class2, "propTypes", {
  // js-sdk User object. Not required because it might not exist.
  user: (prop_types_default()).object
}), CallContextMenu_class2)) || CallContextMenu_class);
...
var DialpadContextMenu_dec, DialpadContextMenu_class;
/*
Copyright 2021 The Matrix.org Foundation C.I.C.
...
let DialpadContextMenu = (DialpadContextMenu_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.context_menus.DialpadContextMenu"), DialpadContextMenu_dec(DialpadContextMenu_class = class DialpadContextMenu extends react.Component {
  constructor(props) {
    super(props);
...
var CallView_dec, CallView_class;
/*
Copyright 2015, 2016 OpenMarket Ltd
Copyright 2019 - 2021 The Matrix.org Foundation C.I.C.
Copyright 2021 Šimon Brandner <simon.bra.ag@gmail.com>
...
let CallView = (CallView_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.voip.CallView"), CallView_dec(CallView_class = class CallView extends react.Component {
  constructor(props) {
    super(props);
    (0,defineProperty/* default */.Z)(this, "dispatcherRef", void 0);
