...
;// CONCATENATED MODULE: ./src/vector/download/index.ts
...
async function initPage() {
  ...
  androidUrl = ``;
  iosUrl = ``;
  iosTestflightUrl = `https://testflight.apple.com/join/nGIMz8oy`;
  ...
  if (androidLink) {
    ...
    if (androidUrl === ``) {
      document.getElementById("androidGoBlank").onclick = function () {
        // const newWindow = window.open('about:blank');
        // newWindow.document.write("<h1>coming soon</h1>");
        alert("coming soon");
        return false;
