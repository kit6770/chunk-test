...
/* harmony import */ var _ContentMessages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(601877);
...
let MStickerBody = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_3__/* .replaceableComponent */ .U)("views.messages.MStickerBody"), _dec(_class = class MStickerBody extends _MImageBody__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(...args) {
    super(...args);
    // Mostly empty to prevent default behaviour of MImageBody
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, "onClick", ev => {
      ev.preventDefault();
  ...
  getPlaceholder(width, height) {
    ...
    if ((_this$props$mxEvent$g = this.props.mxEvent.getContent().info) !== null && _this$props$mxEvent$g !== void 0 && _this$props$mxEvent$g[_ContentMessages__WEBPACK_IMPORTED_MODULE_4__/* .BLURHASH_FIELD */ .kP]) return super.getPlaceholder(width, height);
