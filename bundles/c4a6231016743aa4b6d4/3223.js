...
let MJitsiWidgetEvent = (_dec = (0,_utils_replaceableComponent__WEBPACK_IMPORTED_MODULE_6__/* .replaceableComponent */ .U)("views.messages.MJitsiWidgetEvent"), _dec(_class = class MJitsiWidgetEvent extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  constructor(props) {
    super(props);
  }
  render() {
