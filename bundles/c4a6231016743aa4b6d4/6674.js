...
let Spoiler = (_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.elements.Spoiler"), _dec(_class = class Spoiler extends react.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
...
var MessageEditHistoryDialog_dec, MessageEditHistoryDialog_class, _class2;
/*
Copyright 2019 The Matrix.org Foundation C.I.C.
...
let MessageEditHistoryDialog = (MessageEditHistoryDialog_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.dialogs.MessageEditHistoryDialog"), MessageEditHistoryDialog_dec(MessageEditHistoryDialog_class = (_class2 = class MessageEditHistoryDialog extends react.PureComponent {
  constructor(props) {
    super(props);
...
}, (0,defineProperty/* default */.Z)(_class2, "propTypes", {
  mxEvent: (prop_types_default()).object.isRequired
}), _class2)) || MessageEditHistoryDialog_class);
...
var EditMessageComposer_dec, EditMessageComposer_class, EditMessageComposer_class2;
/*
Copyright 2019 - 2021 The Matrix.org Foundation C.I.C.
...
let EditMessageComposer = (EditMessageComposer_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.rooms.EditMessageComposer"), EditMessageComposer_dec(EditMessageComposer_class = (EditMessageComposer_class2 = class EditMessageComposer extends react.Component {
...
}, (0,defineProperty/* default */.Z)(EditMessageComposer_class2, "contextType", MatrixClientContext/* default */.Z), EditMessageComposer_class2)) || EditMessageComposer_class);
...
NftFavoriteStore_class = NftFavoriteStore;
...
let SdmCard = (SdmCard_dec = (0,replaceableComponent/* replaceableComponent */.U)("views.messages.SdmCard"), SdmCard_dec(SdmCard_class = class SdmCard extends react.Component {
  constructor(props) {
    super(props);
